        ...
        try:
            ...
            if "insuficientes" in body_text or "Não foi possível concluir" in body_text:
                ...
                try:
                    ...
                    print("[FEDERAL] Cookies e storage da sessão limpos para reset do portal.")
                except Exception as clear_err:
                    print(f"[FEDERAL] Erro ao limpar cookies/storage: {clear_err}")
                ...
                try:
                    ...
                    print(f"[FEDERAL] Erro ao recarregar página: {reload_err}. Tentando page.goto...")
                    try:
                        page.goto(url)
                        page.wait_for_selector(cnpj_selector, timeout=15000)
                    except:
                ...
                try:
                    ...
                    print(f"[FEDERAL] Botão de consulta do formulário não encontrado por xpath: {form_err}. Tentando por texto...")
